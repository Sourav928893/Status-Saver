...
import com.coders.wawbstatussaver.font.FontActivity;
import com.coders.wawbstatussaver.fragment.RecentWapp;
import com.coders.wawbstatussaver.fragment.RecentWappBus;
...
import com.coders.wawbstatussaver.warecovermsg.DeletedMsgActivity;
import com.coders.wawbstatussaver.waweb.WAWebActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    LinearLayout container, premiumLayout;
    Button btnGoPremium, btnEnterCode;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Premium Logic
        if (SharedPrefs.isAdsRemoved(this)) {
            premiumLayout.setVisibility(View.GONE);
        } else {
            premiumLayout.setVisibility(View.VISIBLE);
            btnGoPremium.setOnClickListener(v -> {
                Intent browserIntent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://rzp.io/rzp/HToQjWN"));
                startActivity(browserIntent);
            });

            btnEnterCode.setOnClickListener(v -> showPremiumCodeDialog());
            
            // AdMob only if ads not removed
    ...
    private void showPremiumCodeDialog() {
        ...
        builder.setTitle("Enter Premium Code");
        ...
        builder.setPositiveButton("Redeem", (dialog, which) -> {
            ...
            if (code.equals("SOURAV29")) {
                SharedPrefs.setAdsRemoved(MainActivity.this, true);
                premiumLayout.setVisibility(View.GONE);
                container.setVisibility(View.GONE);
                Toast.makeText(MainActivity.this, "Premium Activated! Ads Removed Permanently.", Toast.LENGTH_LONG).show();
                refresh();
            } else {
